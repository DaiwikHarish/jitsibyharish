...
const editPoll = ({ showpollid }: IpollProps) => {
    ...
    function getSeletecdpoll(id: any) {
        setLoading(true);
        fetch(ApiConstants.poll + "?groupId=" + id)
            ...
            .then((selected) => {
                ...
                if (selected.type == "Error") {
                    ...
                    list.map((listQtn: any, index: any) => {
                        let answerOptions = listQtn.answerOptions.map(
                            (listans: any, indexans: any) => {
                                return {
                                    ...listans,
                                    operation: "Update",
                                };
    ...
    const handlePollAnsRemove = (index: any, indexAns: any) => {
        ...
        console.log(indexAns);
        console.log(
            PollAnslist.filter((element) => element.operation != "Remove")
                .length
        );
    ...
    const handlePollOptionAdd = (index: any) => {
        ...
        let indexAns =
            list[index]["answerOptions"][
                list[index]["answerOptions"].length - 1
            ].displaySeqNr;
