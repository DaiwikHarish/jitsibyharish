     ...
     <div id="chat-input" style={{width:"100%",}}> 
            <div className="css-1b1hdkw-inputContainer QA-input">
                <div className="css-1m7m6m3-fieldContainer">
                    ...
                    {/* <div style={{position:'absolute',left:'1%', top:'30%'}} className="jitsi-icon jitsi-icon-default css-1y59anu-icon-iconClickable" >
 ...
 */}
   ...
   if(inputReferenceinpute!=null)
   {
    inputReferenceinpute.current.focus();
                                ...
                                e.preventDefault(); setqa(e.target.value)} }  className="css-qa-input icon-input" placeholder="Your Question here" style={{height: 40,}}>
                                </textarea></div></div>
                                <button aria-label="Send" onClick={() => qaSend(qa)} className="iconButton qabackbtn" style={{backgroundColor:'#094b85'}} title="Send" type="button">
