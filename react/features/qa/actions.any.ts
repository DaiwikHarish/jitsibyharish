...
/**
 * Adds a chat message to the collection of messagesQa.
 *
 ...
 *
 * @param {Object} message - The chat message to edit/override. The messagesQa will be matched from the state
...
/**
 * Clears the chat messagesQa in Redux.
 *
 * @returns {{
 *     type: CLEAR_MESSAGES
 * }}
...
/**
 * Initiates the sending of messagesQa between a moderator and a lobby attendee.
 *
...
/**
 * Removes lobby type messagesQa.
 *
 *  @param {boolean} removeLobbyChatMessages - Should remove messagesQa from chat  (works only for accepted users).
 * If not specified, it will delete all lobby messagesQa.
 *
 * @returns {Object}
 */
