...
/**
 * Implements a container to render all the chat messagesQa in a conference.
 */
class MessageContainer extends AbstractMessageContainer<Props> {
    ...
    /**
     * Renders a message when there are no messagesQa in the chat yet.
     *
     ...
     *
     * @param {Array<Object>} messagesQa - The chat message to render.
     * @returns {React$Element<*>}
     */
    _renderMessageGroup({ item: messagesQa }) {
        return <ChatMessageGroup messagesQa = { messagesQa } />;
    }
}
