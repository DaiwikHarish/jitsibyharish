    ...
    _renderMessage({ index, item: message }) {
        return (
            <ChatMessage
                message = { message }
                showAvatar = {
                    this.props.messagesQa[0].messageType !== MESSAGE_TYPE_LOCAL
                        && index === this.props.messagesQa.length - 1
                }
                showDisplayName = {
                    this.props.messagesQa[0].messageType === MESSAGE_TYPE_REMOTE
                        && index === this.props.messagesQa.length - 1
                }
