...
/**
 * The type of the React {@code Component} props of {@link AudioMuteButtonAdmin}.
 */
 ...
 */
class AudioMuteButtonAdmin extends AbstractAudioMuteButton<Props, *> {
    accessibilityLabel = 'toolbar.accessibilityLabel.mute';
    label = 'toolbar.mute';
    tooltip = 'toolbar.mute';

    /**
     * Initializes a new {@code AudioMuteButtonAdmin} instance.
     *
 ...
 * {@code AudioMuteButtonAdmin} component.
 *
...
export default translate(connect(_mapStateToProps)(AudioMuteButtonAdmin));
