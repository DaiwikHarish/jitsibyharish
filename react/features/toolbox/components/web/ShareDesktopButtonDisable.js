...
import { IconShareDesktopDisable } from '../../../base/icons';
 ...
 */
class ShareDesktopButtonDisable extends AbstractButton<Props, *> {
    accessibilityLabel = 'toolbar.accessibilityLabel.shareYourScreen';
    label = 'toolbar.startScreenSharing';
    icon = IconShareDesktopDisable;
...
export default translate(connect(mapStateToProps)(ShareDesktopButtonDisable));
