...
class Toolbox extends Component<IProps, AppState> {
    ...
    constructor(props: IProps) {
        ...
        this._onToolbarToggleScreenshareAdmin =
            this._onToolbarToggleScreenshareAdmin.bind(this);
        ...
        this._openQADialog = this._openQADialog.bind(this);
    }
    ...
    componentDidMount() {
        ...
        const KEYBOARD_SHORTCUTS = [
            ...
            !_isSpeakerStatsDisabled &&
                isToolbarButtonEnabled("stats", _toolbarButtons) && {
                    character: "T",
    ...
    componentDidUpdate(prevProps: IProps) {
        if (
            this.props._socketReceivedCommandMessage != null &&
            this.props._socketReceivedCommandMessage != undefined
        ) {
            let hasNewMessages =
                this.props._socketReceivedCommandMessage !==
                prevProps._socketReceivedCommandMessage;
    ...
    _getAllButtons() {
        ...
        const profile = _clientType === OptionType.ENABLE_ALL &&
        ...
        const questionAnswer = _attendeeInfo.userType !== UserType.Viewer && {
            ...
            handleClick: this._openQADialog,
            group: 0,
        };

        const desktop = _clientType === OptionType.ENABLE_ALL &&
            this._showDesktopSharingButton() && {
                key: "desktop",
                Content:
                    _attendeeInfo?.userType === UserType.Viewer
                        ? this.state.enableDesktop
                            ? ShareDesktopButton
                            : ShareDesktopButtonDisable
                        : ShareDesktopButton,
                handleClick:
                    _attendeeInfo?.userType === UserType.Viewer
                        ? this._onToolbarToggleScreenshare
        ...
        const raisehand = {
            ...
            Content:
                _attendeeInfo?.userType === UserType.Viewer
                    ? this.state.enableRaiseHand
                        ? ReactionsMenuButton
                        : ReactionsMenuButtonDisable
                    : ReactionsMenuButton,
        ...
        const fullscreen = _attendeeInfo?.userType !== UserType.Viewer &&
            !_isIosMobile && {
                key: "fullscreen",
        ...
        const shareAudio = _attendeeInfo?.userType !== UserType.Viewer &&
            this._showAudioSharingButton() && {
                key: "shareaudio",
        ...
        const whiteboard = _attendeeInfo?.userType !== UserType.Viewer &&
            _whiteboardEnabled && {
                key: "whiteboard",
        ...
        const virtualBackground = _clientType === OptionType.ENABLE_ALL &&
            (_multiStreamModeEnabled || !_screenSharing) && {
        ...
        const shortcuts = _attendeeInfo?.userType !== UserType.Viewer &&
            !_isMobile &&
        ...
        const feedback = _attendeeInfo?.userType !== UserType.Viewer &&
            _feedbackConfigured && {
                key: "feedback",
